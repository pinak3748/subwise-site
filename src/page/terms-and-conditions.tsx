  ...
  return (
    <div className="container mx-auto px-4 lg:px-8 py-12 lg:py-16 max-w-4xl">
      ...
      <img src="/logo.png" alt="Subwise Logo" className="size-16 mb-6 " />
        ...
        <p className="mb-6">
          If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at <a href="mailto:subwise.apps@gmail.com" className="text-primary hover:underline">subwise.apps@gmail.com</a>.
        </p>
      </article>
    </div>
  )
